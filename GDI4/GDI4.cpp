...
// GDI4.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTableApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CTableApp::OnAppAbout)
...
CTableApp::CTableApp()
{
	...
	SetAppID(_T("GDI4.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CTableApp

CTableApp theApp;


// инициализация CTableApp
...
// обработчики сообщений CTableApp
...
void CTableApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CTableApp настройка методов загрузки и сохранения

void CTableApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTableApp::LoadCustomState()
{
}

void CTableApp::SaveCustomState()
{
}
