...
// GDI3.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGDI3App, CWinAppEx)
...
// Единственный объект CGDI3App

CGDI3App theApp;


// инициализация CGDI3App
...
// обработчики сообщений CGDI3App
...
// CGDI3App настройка методов загрузки и сохранения

void CGDI3App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CGDI3App::LoadCustomState()
{
}

void CGDI3App::SaveCustomState()
{
}
