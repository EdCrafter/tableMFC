...
// GDI2.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGDI2App, CWinAppEx)
...
// Единственный объект CGDI2App

CGDI2App theApp;


// инициализация CGDI2App
...
// обработчики сообщений CGDI2App
...
// CGDI2App настройка методов загрузки и сохранения

void CGDI2App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CGDI2App::LoadCustomState()
{
}

void CGDI2App::SaveCustomState()
{
}
