...
// GDI1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGDI1App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CGDI1App::OnAppAbout)
...
CGDI1App::CGDI1App()
{
	...
	SetAppID(_T("GDI1.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CGDI1App

CGDI1App theApp;


// инициализация CGDI1App

BOOL CGDI1App::InitInstance()
{
...
// обработчики сообщений CGDI1App
...
void CGDI1App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CGDI1App настройка методов загрузки и сохранения

void CGDI1App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CGDI1App::LoadCustomState()
{
}

void CGDI1App::SaveCustomState()
{
}
